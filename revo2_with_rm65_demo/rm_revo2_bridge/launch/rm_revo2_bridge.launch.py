...
def generate_launch_description():
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("hand_backend", default_value="sdk"),
            DeclareLaunchArgument("rm_driver_hand_register_pack", default_value="packed_words"),
            DeclareLaunchArgument("rm_driver_byte_pair_order", default_value="high_low"),
                ...
                parameters=[
                    {
                        ...
                        "rm_driver_hand_register_pack": LaunchConfiguration("rm_driver_hand_register_pack"),
                        "rm_driver_byte_pair_order": LaunchConfiguration("rm_driver_byte_pair_order"),
